...
struct ArchiveProcessorApp: App {
    init() {
        ...
        if !d.bool(forKey: "rotationDefaultMigratedV1") {
            if d.string(forKey: "rotationModeRaw") == RotationMode.llmMajority.rawValue {
                d.set(RotationMode.llmSingle.rawValue, forKey: "rotationModeRaw")
            }
            d.set(true, forKey: "rotationDefaultMigratedV1")
        }
        ...
        if !d.bool(forKey: "contextRemovedMigratedV1") {
            d.set(0.0, forKey: "contextCharCount")
            d.set(true, forKey: "contextRemovedMigratedV1")
        }
    }
